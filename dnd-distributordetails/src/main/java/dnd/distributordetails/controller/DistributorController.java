 ...
 */
  ...
  {
	DistributorEntity e = service.updateDistributor(distributor); if (e == null)
	{
    throw new DistributorIdNotFoundException("Update Operation Unsuccessful,Provided Id does not exist"); 
    } 
  else
  {
   return new ResponseEntity<String>("DistributorEntity updated successfully", new HttpHeaders(), HttpStatus.OK); 
   } 
  }
  }
